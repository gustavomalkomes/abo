function [best_model, models, prior, y] = aboms(problem, varargin)

%fprintf('%s BOMS... \n', datestr(now,'yy-mmm-dd-HH:MM'))

noise_old_models_constant = (0.5)^2;
...
if do_BOMS
    ...
    for i=1:numel(init_models)
        ...
        noise_old_models(i) = ...
            noise_old_models_constant/init_models{i}.parameters.number_points;
    end
...
if ~do_BOMS
    ...
    for i = 1:init_num_models
        y(i) = init_models{i}.parameters.log_evidence;
        y(i) = y(i)/init_models{i}.parameters.number_points;
...
for b = 1:eval_budget
    ...
    fprintf('BOMS. Query > Log evidence/n %f Model %s n = %d\n', ...
